...
const particlesData = {
  ...
  location: {
    title: "장소 조사 (Location Particles)",
    description: "장소와 위치를 나타내는 조사들",
    particles: [
      {
        korean: "에서",
        romanization: "e-seo",
  ...
  direction: {
    title: "방향 조사 (Direction Particles)",
    description: "방향과 도구를 나타내는 조사들",
    particles: [
      {
        korean: "(으)로",
        romanization: "(eu)ro",
  ...
  advanced: {
    ...
    description: "더 복잡한 의미를 나타내는 조사들",
    particles: [
      {
        korean: "한테",
        romanization: "han-te",
